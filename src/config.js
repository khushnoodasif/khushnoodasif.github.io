module.exports = {
  ...
  siteDescription:
    'Khushnood Asif is a software engineer based in London, who develops projects using the latest web technologies and frameworks.',
  siteKeywords:
  ...
  siteLanguage: 'en_gb',
  googleAnalyticsID: 'G-HTB434WHXN',
  name: 'Khushnood Asif',
  location: 'London, UK',
